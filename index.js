...
//function changing page content
let historyImg = document.querySelector('.history-image');
function changeImage(){
	historyImg.src = 'image/history2.png';
	historyImg.srcset='image/history2-2x.png 2x';
}
function resetImage(){
	historyImg.src="image/history.png" ;
	historyImg.srcset='image/history2x.png 2x';
}
historyImg.addEventListener('pointerover',changeImage);
historyImg.addEventListener('pointerout',resetImage);
